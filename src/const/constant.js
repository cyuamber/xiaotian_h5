export const POINTINFO = [
  ...
  {
    key: "B",
    info: `3. 集齐CHBN共4个类别的打卡点，获取小天为你准备的大会独家记忆`
  },
  {
    key: "N",
...
export const IMGICON = [
  {
    ...
    infoContent:
      "指在境内面向个人客户提供的各类通信及信息服务。 5G时代，中国移动推出“五新”业务，通过AI赋能AR/VR、视频剪辑、智能通话，实现“新看法、新听法、新玩法、新拍法、新用法”，让广大个人用户沉浸娱乐新体验。",
    number: 0,
    key: "1", // 后端的id
  ...
  },
  {
    ...
    infoContent:
      "指在境内面向家庭客户提供的各类通信及信息服务。 中国移动推出智慧家庭、打造智慧社区，通过“极速+”“娱乐+”“智享+”“安全+”的“4+”智慧产品，让亿万家庭畅享智慧安居新生活。",
    number: 0,
    key: "2",
    fireImgSrc: require("../assets/images/fire3.png")
  },
  {
    ...
    infoContent:
      "指在境内面向政企客户提供的各类通信及信息服务。中国移动正在打造5G+AI行业智能化解决方案，赋能千行百业数字化、智能化转型。",
    number: 0,
    key: "3",
    fireImgSrc: require("../assets/images/fire3.png")
  },
  {
    ...
    infoContent:
      "指独立于境内传统业务的新兴业务板块。中国移动通过布局的产业投资，促进智慧金融等新技术应用，拓展新空间,畅达新未来。",
    number: 0,
    key: "4",
    fireImgSrc: require("../assets/images/fire3.png")
  }
...
export const CHECKRULES = [
  "在大会现场找到中移九天公众号二维码并通过微信扫描，打开推送链接",
  "根据打卡地图指引，在CHBN打卡点处拍照并上传，小天会自动判断是否打卡成功",
  "集齐CHBN共4个类别的打卡点，获取小天为你准备的大会独家记忆",
